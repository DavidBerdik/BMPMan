...
def FolderBrowse(border_width=None, button_text='Browse', target=(ThisRow, -1), initial_folder=None, image_data=None,tooltip=None, size=(None, None),
    ...
    return Button(button_text=button_text, button_type=BUTTON_TYPE_BROWSE_FOLDER, target=target, border_width=border_width,
                  initial_folder=initial_folder, tooltip=tooltip, size=size, auto_size_button=auto_size_button, image_data=image_data,
...
def OneLineProgressMeter(title, current_value, max_value, key, *args, orientation='v', bar_color=(None, None),
                         button_color=None, size=DEFAULT_PROGRESS_BAR_SIZE, border_width=None, grab_anywhere=False, image_data=None):
